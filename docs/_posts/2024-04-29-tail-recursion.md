...
made for a sub-optimal debugging experience since macro expands everything into a single line.
...
Amazingly, the [x86](https://en.wikipedia.org/wiki/X86) version of `SWAP` is barely longer the c version:
